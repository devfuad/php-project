                ...
                <div class="content-wrapper">
                    <div class="container">
                        <div class="row">
                            <div class="col">
                                <div class="page-description">
                                    <h1>Dashboard</h1>
                                    Hi, <b><?= $_SESSION['db_name'];?></b> </br>
                                    Welcome to dashboard </br>
                                    Your email is <b><?= $_SESSION['db_email'];?></b> and id is <b><?= $_SESSION['db_id'];?> </b>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="col-xl-6">
                                ...
                                <?php
                                $total_select_query="SELECT COUNT(*) AS 'totals' FROM users";
                                $total_select_db_impl= mysqli_query($db_connect,$total_select_query);
                                $total_select_db_after_assoc= mysqli_fetch_assoc($total_select_db_impl);
                                
                                ?>

                                    <div class="card-header">
                                        <h5 class="card-title">New Users<span class="badge badge-success badge-style-light"><?php print_r($total_select_db_after_assoc['totals']);?> total</span></h5>
                                    </div>
                                    <div class="card-body">
                                        <!-- <span class="text-muted m-b-xs d-block">showing 5 out of 14 new users.</span> -->

                                        <?php
                                        $db_id_name_email_query= "SELECT id,name,email FROM users";
                                        $db_id_name_email_impl= mysqli_query($db_connect,$db_id_name_email_query);
                                        // $assoc_q= mysqli_fetch_assoc($db_id_name_email_impl);
                                        // print_r($assoc_q);
                                        ?>

                                        <ul class="widget-list-content list-unstyled" style="overflow-y: scroll; height:370px">
                                            <?php
                                            // for ($i=1; $i<=5; $i++) { 
                                            //     # code...
                                            foreach ($db_id_name_email_impl as $key=> $users) { 
                                                # code...
                                            ?>
