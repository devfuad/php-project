                    ...
                    <div class="col-xl-12">
                        <div class="main-menu">
                            <nav class="navbar navbar-expand-lg">
                                <a href="index.php" class="navbar-brand logo-sticky-none"><img src="assets/frontend/assets/frontend/img/logo/logo.png" alt="Logo"></a>
        ...
        <section id="home" class="banner-area banner-bg fix">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <?php
                    $personal_select_q = "SELECT * FROM `personal` WHERE status='active'";
                    $personal_select_impl = mysqli_query($db_connect, $personal_select_q);
                    ?>

                    <?php
                    foreach ($personal_select_impl as $personal) {
                    ?>
                        <div class="col-xl-7 col-lg-6">
                            <div class="banner-content">
                                <h6 class="wow fadeInUp" data-wow-delay="0.2s">HELLO!</h6>
                                <h2 class="wow fadeInUp" data-wow-delay="0.4s">I am <?= $personal['personal_title'] ?></h2>
                                <p class="wow fadeInUp" data-wow-delay="0.6s">I'm <?= $personal['personal_title']?>, <?= $personal['personal_description'] ?></p>
        ...
        <section id="service" class="services-area pt-120 pb-50">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php
                    $select_service_query = "SELECT * FROM `services` WHERE status='active'";
                    $select_service_impl = mysqli_query($db_connect, $select_service_query);
                    ?>

                    <?php
                    foreach ($select_service_impl as $services) {
                    ?>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/frontend/img/images/1.jpg" alt="img">
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/frontend/img/images/2.jpg" alt="img">
                            </div>
                            <div class="speaker-overlay">
                                <span>Video</span>
                    ...
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/frontend/img/images/3.jpg" alt="img">
                            </div>
                            <div class="speaker-overlay">
                                <span>Audio</span>
                    ...
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/frontend/img/images/4.jpg" alt="img">
                            </div>
                            <div class="speaker-overlay">
                                <span>Design</span>
                    ...
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/frontend/img/images/5.jpg" alt="img">
                            </div>
                            <div class="speaker-overlay">
                                <span>Creative</span>
                    ...
                    <div class="col-lg-4 col-md-6 pitem">
                        <div class="speaker-box">
                            <div class="speaker-thumb">
                                <img src="assets/frontend/img/images/6.jpg" alt="img">
                            </div>
                            <div class="speaker-overlay">
                                <span>UX/UI</span>
